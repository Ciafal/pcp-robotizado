...
export const FIELD_LABELS_PT_BR: Record<string, string> = {
  ...
  pcp_approver_id: 'Programador PCP',
  pcpApproverId: 'Programador PCP',
  line_approver_id: 'Programador Substituto',
  lineApproverId: 'Programador Substituto',
  manager_user_id: 'Gestor Operacional Titular',
  pcp_programmer_user_id: 'Programador PCP',
