...
} from '@/services/bottleneck-rules-engine'
...
export function generateCuttingScenarios(
  ...
  return {
    RECOMENDADO_IA: {
      ...
      approval_reason:
        'Aprovação programador PCP mandatória para envio ao SAP após validação da Matriz de Gargalos',
      score_ia: 94,
      bottleneck_impact: BottleneckRulesEngine.evaluateCuttingPlanImpact({
        plan_id: 'SCEN-RECOMENDADO-IA',
        plan_name: 'Cenário Recomendado pela IA (Equilíbrio Global)',
        line_code: plate.line_destination_code || 'L1',
        tarugo_section_mm: plate.thickness_mm || 130,
        tarugo_length_m: (plate.length_mm || 6000) / 1000,
        tarugo_weight_kg: plateWeightKg || 795,
        yield_pct: rec.yieldPct,
        scrap_pct: rec.scrapPct,
        reusable_leftover_pct: rec.leftoverPct,
    ...
    MAIOR_RENDIMENTO: {
      ...
      score_ia: 87,
      bottleneck_impact: BottleneckRulesEngine.evaluateCuttingPlanImpact({
        plan_id: 'SCEN-MAIOR-RENDIMENTO',
        plan_name: 'Cenário Maior Rendimento Bruto',
        line_code: plate.line_destination_code || 'L1',
        tarugo_section_mm: plate.thickness_mm || 130,
        tarugo_length_m: (plate.length_mm || 6000) / 1000,
        tarugo_weight_kg: plateWeightKg || 795,
        ...
        scrap_pct: Math.max(2, rec.scrapPct - 2),
        reusable_leftover_pct: Math.max(0, rec.leftoverPct - 2),
        tcc_bar_length_m: 71.5,
        tcc_bars_per_rack: 13,
        bar_interval_seconds: 3.4,
        crop_end_weight_kg: 14.2,
        target_demand_fulfillment_pct: 88,
      }),
    ...
    MENOR_CUSTO: {
      ...
      score_ia: 91,
      bottleneck_impact: BottleneckRulesEngine.evaluateCuttingPlanImpact({
        plan_id: 'SCEN-MENOR-CUSTO',
        plan_name: 'Cenário Menor Custo Operacional',
        line_code: plate.line_destination_code || 'L1',
        tarugo_section_mm: plate.thickness_mm || 130,
        tarugo_length_m: (plate.length_mm || 6000) / 1000,
        tarugo_weight_kg: plateWeightKg || 795,
        ...
        scrap_pct: rec.scrapPct + 1,
        reusable_leftover_pct: rec.leftoverPct,
        tcc_bar_length_m: 66.0,
        tcc_bars_per_rack: 11,
        bar_interval_seconds: 3.9,
        crop_end_weight_kg: 11.5,
        target_demand_fulfillment_pct: 92,
      }),
    ...
    MENOR_SUCATA: {
      ...
      score_ia: 89,
      bottleneck_impact: BottleneckRulesEngine.evaluateCuttingPlanImpact({
        plan_id: 'SCEN-MENOR-SUCATA',
        plan_name: 'Cenário Menor Sucata Descartada',
        line_code: plate.line_destination_code || 'L1',
        tarugo_section_mm: plate.thickness_mm || 130,
        tarugo_length_m: (plate.length_mm || 6000) / 1000,
        tarugo_weight_kg: plateWeightKg || 795,
        ...
        scrap_pct: Math.min(3, rec.scrapPct),
        reusable_leftover_pct: rec.leftoverPct + 3,
        tcc_bar_length_m: 67.5,
        tcc_bars_per_rack: 12,
        bar_interval_seconds: 3.7,
        crop_end_weight_kg: 12.0,
    ...
    PRESERVACAO_CRITICA: {
      ...
      score_ia: 86,
      bottleneck_impact: BottleneckRulesEngine.evaluateCuttingPlanImpact({
        plan_id: 'SCEN-PRESERVACAO-CRITICA',
        plan_name: 'Cenário Preservação de MP Crítica',
        line_code: plate.line_destination_code || 'L1',
        tarugo_section_mm: plate.thickness_mm || 130,
        tarugo_length_m: (plate.length_mm || 6000) / 1000,
        tarugo_weight_kg: plateWeightKg || 795,
        ...
        scrap_pct: rec.scrapPct + 2,
        reusable_leftover_pct: rec.leftoverPct + 1,
        tcc_bar_length_m: 65.0,
        tcc_bars_per_rack: 10,
        bar_interval_seconds: 4.1,
        crop_end_weight_kg: 10.8,
        target_demand_fulfillment_pct: 85,
      }),
    ...
    MAIOR_CARTEIRA: {
      ...
      score_ia: 92,
      bottleneck_impact: BottleneckRulesEngine.evaluateCuttingPlanImpact({
        plan_id: 'SCEN-MAIOR-CARTEIRA',
        plan_name: 'Cenário Maior Atendimento da Carteira',
        line_code: plate.line_destination_code || 'L1',
        tarugo_section_mm: plate.thickness_mm || 130,
        tarugo_length_m: (plate.length_mm || 6000) / 1000,
        tarugo_weight_kg: plateWeightKg || 795,
        ...
        bar_interval_seconds: 3.8,
        crop_end_weight_kg: 12.0,
        target_demand_fulfillment_pct: 100,
      }),
    ...
    PERSONALIZADO_HUMANO: {
      ...
      score_ia: 90,
      bottleneck_impact: BottleneckRulesEngine.evaluateCuttingPlanImpact({
        plan_id: 'SCEN-PERSONALIZADO-HUMANO',
        plan_name: 'Cenário Ajustado Manualmente pelo PCP',
        line_code: plate.line_destination_code || 'L1',
        tarugo_section_mm: plate.thickness_mm || 130,
        tarugo_length_m: (plate.length_mm || 6000) / 1000,
        tarugo_weight_kg: plateWeightKg || 795,
