...
const navSections: NavSectionItem[] = [
  ...
  },
  {
    ...
    subItems: [
      {
        title: 'Visão Geral',
        href: '/pcp/reunioes/visao-geral',
        icon: LayoutDashboard,
        permission: 'pcp.meeting.view',
      },
      {
        title: 'Preparação da Reunião',
        href: '/pcp/reunioes/preparacao',
        icon: Sparkles,
        permission: 'pcp.meeting.view',
      },
      {
        title: 'Agenda de Reuniões',
        href: '/pcp/reunioes/agenda',
        icon: CalendarDays,
        permission: 'pcp.meeting.view',
      },
      {
      ...
      {
        title: 'Histórico',
        href: '/pcp/reunioes/historico',
        icon: History,
        permission: 'pcp.meeting.view',
      },
      {
        title: 'Configurações',
        href: '/pcp/reunioes/configuracoes',
        icon: Sliders,
        permission: 'pcp.meeting.view',
      },
    ],
    ...
    subItems: [
      {
        ...
        href: '/pcp/analise-carteira/geral',
        icon: LayoutDashboard,
        permission: 'pcp.carteira.view',
      },
      {
        title: 'Carteira L1',
        href: '/pcp/analise-carteira/l1',
        icon: Layers,
        permission: 'pcp.carteira.view',
      },
      {
        title: 'Carteira L2',
        href: '/pcp/analise-carteira/l2',
        icon: Layers,
        permission: 'pcp.carteira.view',
      },
      {
        title: 'Carteira MTO',
        href: '/pcp/analise-carteira/mto',
        icon: PackageCheck,
        permission: 'pcp.carteira.view',
      },
      {
        title: 'Carteira Revenda',
        href: '/pcp/analise-carteira/revenda',
        icon: ShoppingBag,
        permission: 'pcp.carteira.view',
      },
      {
        title: 'Carteira Importado',
        href: '/pcp/analise-carteira/importado',
        icon: Globe2,
        permission: 'pcp.carteira.view',
      },
      {
...
const officialNavGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'Pendências - COGI',
        href: '/pcp/controle-producao/cogi',
        icon: Boxes,
        permission: 'pcp.production.view',
      },
      {
        title: 'Pendências - CO1P',
        href: '/pcp/controle-producao/co1p',
        icon: FileCheck2,
        permission: 'pcp.production.view',
      },
      {
  ...
  {
    groupTitle: 'ANÁLISE DE CARTEIRA',
    items: [
      {
        title: 'Carteira Geral',
        href: '/pcp/analise-carteira/geral',
