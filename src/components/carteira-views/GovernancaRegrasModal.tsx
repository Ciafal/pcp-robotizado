...
import { Sliders, Shield, Save, Calendar, Clock } from 'lucide-react'
...
export const GovernancaRegrasModal: React.FC<GovernancaRegrasModalProps> = ({
  ...
  return (
    <AnalyticalModal
      ...
      onClose={onClose}
      size="analytical"
      badge="PCP & Governança"
      title="Governança & Parametrização do Motor de Regras"
      subtitle="Parametrize classificações, janelas de tolerância e regras de negócio com versionamento auditável."
      headerKpis={[
        { label: 'Janela Histórico', value: `${periodoFaturamento} dias`, variant: 'default' },
        { label: 'Alerta Atenção', value: `${limiteAtencao} dias`, variant: 'warning' },
        { label: 'Alerta Crítico', value: `${limiteCritico} dias`, variant: 'danger' },
      ]}
      footer={
      ...
      <div className="space-y-4 text-xs">
        ...
        <div className="p-3 bg-blue-50/70 rounded-xl border border-blue-200 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Badge className="bg-[#004C97] text-white text-[10px]">Central PCP (7 Carteiras)</Badge>
          </div>
          <p className="text-[11px] text-slate-600">
            Padronização obrigatória em todas as carteiras (Geral, L1, L2, MTO, Revenda, Importado e
            SDC).
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
            ...
            <div className="flex items-center justify-between p-2 bg-white rounded border border-blue-100">
              ...
              <button
                ...
                className={`text-[11px] px-2 py-0.5 rounded font-bold ${
                  considerarBloqueado ? 'bg-rose-100 text-rose-800' : 'bg-slate-100 text-slate-600'
                }`}
              >
        ...
        <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-200 space-y-2">
          <div className="flex items-center justify-between">
            <span className="font-bold text-[#004C97] flex items-center gap-1.5">
              <Shield className="w-4 h-4 text-[#004C97]" /> Justificativa Obrigatória de Governança
            </span>
            <Badge className="bg-slate-200 text-slate-800 text-[10px]">Auditado pelo AD/PCP</Badge>
          </div>
