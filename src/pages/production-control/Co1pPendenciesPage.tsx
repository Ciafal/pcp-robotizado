...
export const Co1pPendenciesPage: React.FC = () => {
  ...
  const handleOpenDetail = (record: SapCo1pPendency, tab: string = 'dados-sap') => {
  ...
  return (
    <div>
      <div className="space-y-3.5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Processamento posterior de confirmações de produção SAP
              </p>
            </div>
          </div>
        ...
        <ErrorBoundary moduleName="Cards Executivos CO1P">
          {loading ? (
        ...
        <ErrorBoundary moduleName="Painel IA CO1P">
          {loading ? (
        ...
        <ErrorBoundary moduleName="Filtros CO1P">
        ...
        {/* 4. Tabela Responsiva de Pendências CO1P */}
        <ErrorBoundary moduleName="Tabela CO1P">
          <div className="bg-white border border-slate-200 rounded-lg shadow-2xs overflow-hidden">
            <div className="px-4 py-2 border-b border-slate-200 flex items-center justify-between text-xs bg-slate-50">
              ...
              <span className="text-[11px] text-slate-500 font-mono">
                Processamento posterior de confirmações de produção
              </span>
            </div>
              ...
              <table className="w-full text-left text-xs border-collapse">
                <thead className="bg-slate-100/90 text-slate-700 font-bold uppercase text-[10px] tracking-wider sticky top-0 z-10 border-b border-slate-200">
                  <tr>
                    ...
                    <th className="py-2.5 px-3">Confirmação</th>
                    <th className="py-2.5 px-3">Contador</th>
                  ...
                  {loading ? (
                    ...
                    list.map((item) => (
                      ...
                      >
                        ...
                        {/* Confirmação */}
                        <td className="py-2 px-3 whitespace-nowrap font-mono text-slate-800 font-semibold">
                          {item.confirmation_number}
                        </td>

                        {/* Contador */}
                        <td className="py-2 px-3 whitespace-nowrap font-mono text-slate-600">
                          {item.confirmation_counter}
                        </td>
                        ...
                        {/* Centro de trabalho */}
                        <td className="py-2 px-3 whitespace-nowrap font-mono text-slate-600">
                          {item.work_center || item.linha_code || '-'}
                        </td>
